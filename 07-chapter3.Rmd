...
load_or_install(c('fitdistrplus','foreach','ggplot2','scales','proto','Cairo','doBy','plyr','dplyr','readxl','lattice','GGally','tidyverse','tibble', 'moments', 'nortest', 'e1071', 'Hmisc', 'NADA', 'ggthemes','STAND', 'scatterplot3d', 'plotly', 'scales', 'beeswarm', 'gridExtra', 'lme4', 'lattice', 'reshape2', 'compiler', 'parallel', 'boot', 'effects', 'stargazer', 'lubridate', 'anytime', 'chron','RColorBrewer','circular','splitstackshape','multcomp','pander','xtable'))
...
```{r load.am.asd.gm.gsd.function.ch3, include=F}
...
library(png)
library(grid)
img <- readPNG("/home/ejkasner/example.dissertation/Images/BelowSampling1.png")
 grid.raster(img)
```
